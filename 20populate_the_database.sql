...
-- why using two selects to get the category_id : https://stackoverflow.com/a/43610081/21996724 (if not: Error Code: 1093. You can't specify target table 'categories' for update in FROM clause)
INSERT INTO categories (name, description, parent_id) VALUES
('Notebook', 'Portable laptops and notebooks', (SELECT * FROM (SELECT id FROM categories WHERE name = 'Electronics')as c)),
('Desktop', 'Desktop computers', (SELECT * FROM(SELECT id FROM categories WHERE name = 'Electronics')as c)),
('Tablet', 'Tablet computers', (SELECT * FROM(SELECT id FROM categories WHERE name = 'Electronics')as c)),
('Phone', 'Mobile phones and smartphones', (SELECT * FROM(SELECT id FROM categories WHERE name = 'Electronics')as c));
...
('Brand', (SELECT id FROM categories WHERE name = 'Computer Parts')),
('Model', (SELECT id FROM categories WHERE name = 'Computer Parts'));
...
-- CPUs
('AMD Ryzen 7 5800X', '8-core processor for gaming and productivity', 299.99, 50, (SELECT id FROM categories WHERE name = 'Processor')),
('Intel Core i9-12900K', 'High-end desktop processor', 589.99, 30, (SELECT id FROM categories WHERE name = 'Processor')),

-- RAM
('Corsair Vengeance LPX 16GB', 'High-performance DDR4 RAM', 89.99, 100, (SELECT id FROM categories WHERE name = 'RAM')),
('G.Skill Ripjaws V 32GB', 'Dual channel DDR4 memory kit', 129.99, 75, (SELECT id FROM categories WHERE name = 'RAM')),

-- Graphics Cards
('MSI GeForce RTX 4070 SUPER', 'High-end graphics card', 899.99, 20, (SELECT id FROM categories WHERE name = 'Graphic Card')),
('AMD RX 6800 XT', 'Gaming graphics card', 649.99, 25, (SELECT id FROM categories WHERE name = 'Graphic Card'));
...
((SELECT id FROM products WHERE name = 'AMD Ryzen 7 5800X'),
 (SELECT id FROM attributes WHERE name = 'Brand'),
 'AMD'),
((SELECT id FROM products WHERE name = 'AMD Ryzen 7 5800X'),
 (SELECT id FROM attributes WHERE name = 'Model'),
 'Ryzen 7 5800X'),
((SELECT id FROM products WHERE name = 'AMD Ryzen 7 5800X'),
